...
export const {setCity,setLng,setLat,setFirstCity,setWeatherDataRedux} = locationSlice.actions
...
export const selectWeatherDataRedux = (state: RootState) => state.location.weatherDataRedux
