  ...
  return (
    ...
    <div className="max-w-100vw mx-auto">
      <div className="bg-green-500 p-4 flex w-full items-center justify-between ">
        <ChevronLeftIcon onClick={()=>router.back()} className="text-black" />
        <h1 className="text-black text-lg font-semibold">Farming Equipments</h1>
        <Link href={`/city/${props.params.slug}/machineRenting/sell`} className="bg-white ml-5 text-green-500 font-semibold rounded py-1 px-3">
          SELL
        </Link>
